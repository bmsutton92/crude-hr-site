...
export const caseStudies = [
  {
    ...
    problem: {
      ...
      paragraphs: [
        'Ticket #107559 was written by hand at a wellsite in Lea County, NM on 10/26/2023. The billing codes that made it invoiceable (AFE 23106, Cost Code 9582) were not added until 11/6/23. For 11 days, nearly $43K in completed work sat in a truck cab, uninvoiced.',
    ...
    fix: {
      ...
      intro:
        'When a ticket goes digital, every handoff that used to take days happens at submission. The crew logs operational units in the field, a live GPS stamp locks the sign-off, and validated AFE codes ride along. Contract pricing is pulled straight from your ERP, never typed or estimated on-site, then the priced ticket syncs to your ERP and payroll system on a schedule with no manual re-entry.',
      columns: ['Pipeline stage', 'Manual paper', 'Crude HR digital'],
      rows: [
        ['Ticket generation', 'Operator handwrites details at the wellsite', 'Mobile app entry, operational units only'],
        ...
        ['Contract pricing', 'Estimated from memory or a stale rate sheet', 'Pulled directly from your ERP at the supervisor gate'],
        ['ERP & payroll entry', '1-3 days of clerk typing', 'Scheduled sync to your ERP and payroll system'],
      ],
    ...
    deepDive: [
      {
        ...
        text: 'No JSA check, no submission. The app blocks a ticket until safety documentation is complete and a live GPS stamp proves the operator is at the designated wellsite, so safety stops being retroactive paperwork.',
      },
      {
    ...
    bottomLine: [
      ...
      { value: '1.5-3.0%', text: 'Margin recovered when pricing comes straight from the ERP, not memory.' },
    ...
    tools: ['Mobile field ticketing app', 'Live ERP contract pricing', 'GPS-stamped digital sign-off', 'ERP & payroll sync'],
    ...
    cta: {
      ...
      text: "We'll map your ticket workflow, connect it to your ERP pricing, and show you the payback math for your operation.",
    },
  },
  {
...

  {
    ...
    featured: true,
    title:
      "$38,200 in standby sat forgotten in a cab. Here's how ERP-priced digital tickets recovered 100% of pass-through margin.",
    summary:
    ...
    fix: {
      heading: 'From handwritten margin notes to ERP-priced line items',
      intro:
        "By auditing the ticketing process, Crude HR builds a digital ticket that captures every line item and pass-through as it happens in the field. Each one is priced directly from the client's contract rates in your ERP, so nothing gets squeezed into a margin note or billed at the wrong tier.",
      columns: ['Pipeline stage', 'Manual paper', 'Digitized workflow (via Crude HR)'],
      rows: [
        ['Standby tracking', 'Handwritten margin notes', 'Captured as a digital line item, priced from your ERP'],
        ['Pass-through billing', 'Receipts stapled to paper tickets', 'Instant photo upload linked to billing line-item'],
        ['Contract rate verification', 'Manual lookup in office binder', 'Rates pulled live from your ERP contract file'],
        ['ERP data entry', '2-3 days manual clerk keying', 'Direct sync into your ERP'],
      ],
    ...
    ledger: {
      ...
      right: {
        ...
        intro:
          'Pricing pulled straight from your ERP means the first invoice is the right invoice, with no awkward follow-up calls asking for more money weeks after the job.',
        statuses: [
    ...
    deepDive: [
      {
        title: 'Live ERP pricing: rate disputes eliminated before submission',
        text: "Custom digital architecture ties every ticket to the customer's contracted rate sheet in your ERP. The crew logs the equipment and pass-throughs; the system applies the exact contracted rate, preventing accidental under-billing or rate mismatches at the source.",
      },
      {
    ...
    tools: ['Custom mobile ticketing', 'Live ERP contract pricing', 'Direct ERP & accounting sync'],
    relatedServices: ['Business Process Automation', 'Workflow and Systems Consulting', 'Fractional HR Support'],
    cta: {
      heading: 'Stop leaking margin. Start locking in rates.',
      text: "We'll connect your ERP contract pricing and show you the payback math for your operation.",
    },
  },
